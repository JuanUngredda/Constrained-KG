...
def function_caller_NN_TS(rep_base):
    ...
    for it in [0,1]:
        ...
        x = np.array([[1, 0.5, 0.5, 0.5, 3, 3, 3, 1, 1],
                      [1, 0.5, 0.5, 0.5, 4, 4, 4, 1, 1],
                      [1, 0.5, 0.5, 0.5, 5, 5, 5, 1, 1],
                      [1, 0.5, 0.5, 0.5, 6, 6, 6, 1, 1],
                      [1, 0.5, 0.5, 0.5, 7, 7, 7, 1, 1],
                      [1, 0.5, 0.5, 0.5, 8, 8, 8, 1, 1],
                      [1, 0.5, 0.5, 0.5, 9, 9, 9, 1, 1],
                      [1, 0.5, 0.5, 0.5, 10, 10, 10, 1, 1]])
        #
        cval = RMITD_f.c(x)
