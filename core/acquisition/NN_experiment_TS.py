...
def function_caller_NN_TS(rep_base):
    ...
    for it in [0]:
        ...
        # x = np.array([[0.5, 0.5, 0.5, 0.5, 2, 2, 2, 0.6, 0.6],
        #               [0.5, 0.5, 0.5, 0.5, 3, 3, 3, 0.6, 0.6],
        #               [0.5, 0.5, 0.5, 0.5, 4, 4, 4, 0.9, 0.9],
        #               [0.5, 0.5, 0.5, 0.5, 5, 5, 5, 0.9, 0.9],
        #               [0.5, 0.5, 0.5, 0.5, 6, 6, 6,  0.9, 0.9],
        #               [0.5, 0.5, 0.5, 0.5, 7, 7, 7,  0.9, 0.9],
        #               [0.5, 0.5, 0.5, 0.5, 8, 8, 8,  0.9, 0.9],
