import numpy as np
from GPyOpt.objective_examples.experiments2d import mistery_torch,  test_function_2, new_brannin_torch
...
def function_caller_branin_nEI(it):
    ...
    for rep in repepetitions:
        ...
        for noise in [ 1.0]:
            ...
            for iteration in range(1, N_BATCH + 1):
                ...
                folder = "RESULTS"
                subfolder = "branin_nEI_n_obj_" + str(NOISE_SE) + "_n_c_" + str(NOISE_SE_constraint)
                cwd = os.getcwd()
