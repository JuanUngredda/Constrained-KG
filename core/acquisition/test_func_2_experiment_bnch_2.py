...
def function_caller_test_func_2_penalised(rep):
    rep = rep
    np.random.seed(rep)
    for noise in [1.0]:
        # func2 = dropwave()
        ...
        subfolder = "test_function_2_penalised_hybrid_KG_n_obj_" + str(noise_objective) + "_n_c_" + str(noise_constraints)
        folder = "RESULTS"
        cwd = os.getcwd()
        ...
        print("Code Ended")
        print("X",X,"Y",Y, "C", C)
# function_caller_test_func_2_penalised(rep=12)
