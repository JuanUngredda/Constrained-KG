...
class BO(object):
    ...
    def run_optimization(self, max_iter = 1, max_time = np.inf,  eps = 1e-8, context = None, verbosity=False, path = None, evaluations_file = None):
        ...
        self.X = np.array([[2.25 ,      4.25      ],
                     ...
                     [0.75       ,0.25      ],
                     [4.25       ,0.75      ],
                     [2.20211548 ,2.19477216],
                     [0.04595139 ,3.39140756],
                     [0.01009704 ,0.9979044 ],
                     [0.         ,5.        ],
                     [0.97360632 ,0.        ],
                     [0.         ,0.0084109 ],
                     [2.70372251 ,2.31516822],
                     [2.75331707 ,2.3537264 ],
                     [2.80995759 ,0.        ],
                     [2.84686564 ,2.26190786],
                     [2.87994044 ,2.23072944],
                     [2.80603271 ,2.40821456],
                     [2.69330723 ,2.36645918],
                     [2.77914351 ,2.36658396],
                     [2.67764762 ,1.45724459],
                     [2.74484222 ,2.3519261 ],
                     [2.74481489 ,2.35192188],
                     [2.81355225 ,2.29325026],
                     [2.75471291 ,2.35950882],
                     [2.88221603 ,2.23450721],
                     [2.69357991 ,2.3815917 ],
                     [2.88215515 ,2.35205347],
                     [2.88247349 ,2.35235852],
                     [2.67660748 ,2.41119637],
                     [2.74507644 ,2.35222267],
                     [2.75154844 ,2.3574748 ],
                     [2.74501264 ,2.35217369],
                     [2.7450758  ,2.35224311],
                     [2.74483608 ,2.46960914],
                     [2.73772352 ,2.34296988],
                     [2.74518606 ,2.35236492],
                     [2.745007   ,2.35218958]])
