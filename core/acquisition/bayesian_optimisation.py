...
class BO(object):
    ...
    def run_optimization(self, max_iter = 1, max_time = np.inf,  eps = 1e-8, context = None, verbosity=False, path = None, evaluations_file = None):
        ...
        #                      [0.15      , 0.05      ],
        #                      [0.85      , 0.15      ],
        #                      [0.17315385, 0.97561767],
        #                      [0.01000006, 0.23000025],
        #                      [0.08999998, 0.78999996],
        #                      [0.24665709, 0.16673363],
        #                      [0.15000123, 0.24999964],
        #                      [0.38999755, 0.14999906],
        #                      [0.2499945 , 0.80998218],
        #                      [0.07      , 0.93      ]])
